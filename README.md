...
* `notebooks/baseline_LCA_ResNet18.ipynb` - Первый эксперимент (с воспроизведением эксперимента, при поиске параметров) 
...
* `notebooks/baseline_LCA_ResNet18_v2.ipynb` - Изменена learning rate
...
* `notebooks/baseline_LCA_ResNet18_v3.ipynb`
